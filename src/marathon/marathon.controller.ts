...
export class MarathonController {
  ...
  @ApiResponse({ status: 201, description: 'Marathon created successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Returns all marathons' })
  @Get()
  findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Returns the marathon' })
  ...
  @ApiResponse({ status: 200, description: 'Marathon updated successfully' })
  @ApiParam({ name: 'id', description: 'Marathon ID' })
  ...
  @ApiResponse({ status: 200, description: 'Marathon deleted successfully' })
  @ApiParam({ name: 'id', description: 'Marathon ID' })
  @Delete(':id')
  @UseGuards(AdminGuard)
  ...
  @ApiResponse({ status: 200, description: 'Successfully joined the marathon' })
  @ApiParam({ name: 'id', description: 'Marathon ID' })
  @ApiBody({ 
    schema: {
      type: 'object',
  ...
  @ApiResponse({ status: 200, description: 'Returns all participants of the marathon' })
  @ApiParam({ name: 'id', description: 'Marathon ID' })
  @Get(':id/participants')
